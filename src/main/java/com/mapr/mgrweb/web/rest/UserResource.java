...
import com.mapr.mgrweb.web.rest.errors.EmailAlreadyUsedException;
import com.mapr.mgrweb.web.rest.errors.LoginAlreadyUsedException;
import java.net.URI;
...
public class UserResource {
    ...
    public UserResource(UserService userService, MapRUserRepository userRepository, MailService mailService) {
    ...
    public ResponseEntity<UserDTO> updateUser(@Valid @RequestBody UserDTO userDTO) {
        ...
        if (existingUser.isPresent() && (!existingUser.get().get_id().equals(userDTO.getId()))) {
            throw new EmailAlreadyUsedException();
        }
